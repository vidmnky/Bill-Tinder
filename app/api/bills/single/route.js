...
export async function GET(request) {
  ...
  const selectFields = 'id, external_id, title, summary, summary_liberal, summary_conservative, impact_line, sponsor_name, sponsor_state, level, state, status, introduced_date';
